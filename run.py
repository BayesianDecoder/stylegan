...
def run_phase(label: str, variable: Variable, lr: float, optimizer_cls=NGD):
        ...
        with directory(experiment_path):
            ...
            for j, image_path in enumerate(image_paths):
                with directory(f"inversions/{j:04d}"):
                    ...
                    w_scores = run_phase("W", W_variable, config.global_lr_scale * 0.08, optimizer_cls=LBFGSPhase)
